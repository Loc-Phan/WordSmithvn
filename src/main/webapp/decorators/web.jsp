...
<body id="page-top">
	...
	<script
		...
		<script
		src="<c:url value='/template/web/js/sb-admin-2.min.js'/>"></script>
			<script
		src="<c:url value='/template/web/vendor/chart.js/Chart.min.js'/>"></script>
				<script
		src="<c:url value='/template/web/js/demo/chart-area-demo.js'/>"></script>
					<script
		src="<c:url value='/template/web/js/demo/chart-pie-demo.js'/>"></script>
</body>
</html>